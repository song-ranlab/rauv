...
# Hardware Used
We are using the Jetson Xavier, two Raspberry Pi 4's, and Pixhawk as processor boards that will run the autonomy software. The idea to use these specific boards is because we wanted to implement Machine Learning algorithms via Computer Vision to allow the submarine to "see" it's targets.
